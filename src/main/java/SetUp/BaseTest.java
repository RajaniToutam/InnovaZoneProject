...
//default constructor
    ...
    public void launchBrowser(@Optional("chrome") String browserName, @Optional("https://qa.izhips.com/admin/login") String url, @Optional("C:\\chromedriver_win32\\chromedriver.exe") String localDriverPath) throws IOException, InterruptedException{
