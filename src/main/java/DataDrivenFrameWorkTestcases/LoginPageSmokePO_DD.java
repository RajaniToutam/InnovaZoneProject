...
public class LoginPageSmokePO_DD extends BasePage {

    public LoginPageSmokePO_DD(WebDriver driver) {
        super(driver);
    }
...
////////////Testcase-01****Login and register in the automation website/////////////
    ...
    public By ShoppingUpdate_xpath = By.xpath("//ul[@id = 'address_delivery']/li[8]//a[@title = 'Update']");  //Not able to get it --update showing two //ul[@id = 'address_delivery']//span[text()= 'Update']
    ...
    public By ShippingProceedToCheckout = By.xpath("//button[@name = 'processCarrier']");
    public By ShippingTermConditions = By.xpath("//div[@id = 'uniform-cgv']//input[@id= 'cgv']");
    public By ShippingProceedToCKout1 = By.xpath(" //button[@name= 'processCarrier']");

    /////////////////////////////Locator End///////////////////////////
    //////////////////////////////  Method Start///////////////////////

    public boolean enterTextInInputField(By locatorName, String text) {
        try {
    ...
    public boolean clickAlert() throws Exception {
        try {
            WebElement addToCartBtn = (new WebDriverWait(driver, 90))
                    .until(ExpectedConditions.visibilityOfElementLocated(PrintedDress_xpath));
            ...
            if (addToCartBtn.isDisplayed()) {
                ...
                Alert AddToCart = driver.switchTo().alert();
                AddToCart.accept();
                return true;
